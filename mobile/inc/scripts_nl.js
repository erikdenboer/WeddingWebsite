...
function didTheySayYes(x) {
    ...
    case 0:                                                                         //Response to 'not joining'
        ...
        name1.innerHTML = `Heel jammer dat we je/jullie zullen moeten missen!<br>
        <label for="name1">Naam:<br></label>
    ...
    case 1:                                                                         //Response to 'will join'
        ...
        some.innerHTML =`<br><label for="groupsize">Met hoeveel gasten?<br></label>
        ...
        break;
    default:
        alert('Sorry, er is iets fout gegaan! Probeer het nog eens of neem anders contact op met de bruidegom.');
        break;
    }
}
...
function food(i) {
    ...
    '<br><label for="' + foodX + `">Wat wil je graag eten?<br></label>
    <select id="` + foodX + '" name="' + foodX + `" required>
        <option value="Meat">Vlees</option>
        <option value="Fish">Vis</option>
        <option value="Vegetarian">Vegetarisch</option>
        <option value="Other">Iets anders - vul het commentaarveld in</option>
    </select>`;
    return;
}
...
function guestname(i) {
    ...
    '<br><label for="' + nameX + '">Naam:<br></label>' +
...
function RSVPsize() {
    ...
    if (x == 'null') {                                      //Don't respond to empty option
        ...
        case 3:
            ...
            placeholder="Laat ons hier weten of je allergieën hebt of andere dieetwensen, dan doen we onze best om hiermee rekening te houden!"></textarea>`;
        break;
        case 4:
            alert("We verwachten niet dat iemand zo'n grote groep meeneemt." +
            "Als je verkeerd geklikt hebt, corrigeer dit dan even, en neem anders contact met ons op om er zeker van te zijn dat er genoeg plek is.");
        break;
        default:
        	alert("Er is iets misgegaan! Ververs even de pagina en probeer het nogmaals. Blijf je problemen hebben, neem dan contact op met de bruidegom.")
        break;
        }
    }
}
